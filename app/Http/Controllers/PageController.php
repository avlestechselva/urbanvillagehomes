    ...
    public function show_properties(Request $request)
{
    ...
    // Set department based on url_type or residence parameter and set preselection flags
    $preselect_buy = false;
    $preselect_rent = false;
    ...
    // Override preselection with explicit query parameters if they exist
    if (request()->has('rent') || request()->has('buy')) {
        $preselect_rent = request()->query('rent') == 1;
        $preselect_buy = request()->query('buy') == 1;
    }

    // Handle rent/buy checkbox filters
    if ($preselect_rent && !$preselect_buy) {
        // Only rent properties
    ...
    elseif (!$preselect_rent && $preselect_buy) {
        // Only buy properties
    ...
    return view(
        ...
        [
            ...
            'preselect_buy'          => $preselect_buy,
            'preselect_rent'         => $preselect_rent,
        ]
    );
}
    ...
    public function show_free_home_staging_consultation()
    {
        ...
        return view(
            'pages.free_home_staging_consultation',
            [
    ...
    public function show_home_staging_consultation_request()
    {
        ...
        return view(
            'pages.home_staging_valuation_request',
            [
    ...
    public function show_ferndene_road_herne_hill()
    {
        ...
        return view(
            'pages.ferndene_road_herne_hill',
            [
    ...
    public function show_finsen_road_denmark_hill()
    {
        ...
        return view(
            'pages.finsen_road_denmark_hill',
            [
    ...
    public function show_kemerton_road_denmark_hill()
    {
        ...
        return view(
            'pages.kemerton_road_denmark_hill',
            [
    ...
    public function show_highwood_garden_terrace_north()
    {
        ...
        return view(
            'pages.highwood_garden_terrace_north',
            [
    ...
    public function show_albert_embankment_london()
    {
        ...
        return view(
            'pages.albert_embankment_london',
            [
    ...
    public function show_gilesmead_camberwell_church_street()
    {
        ...
        return view(
            'pages.gilesmead_camberwell_church_street',
            [
