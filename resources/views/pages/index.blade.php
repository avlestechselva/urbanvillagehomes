                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="sold-cards">
                                <p>
                                    <b class="text-dark">£ @if($property->rent) {{ number_format($property->rent).'/'.$property->rentFrequency }} @else {{ number_format($property->price) }} @endif</b>
                                    <br>
